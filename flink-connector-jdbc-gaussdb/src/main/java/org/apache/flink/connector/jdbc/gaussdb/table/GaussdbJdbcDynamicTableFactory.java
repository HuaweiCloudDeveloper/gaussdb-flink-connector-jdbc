...
import static org.apache.flink.connector.jdbc.gaussdb.table.GaussdbExtendConnectorOptions.SINK_IGNORE_NULL_WHEN_UPDATE;
...
public class GaussdbJdbcDynamicTableFactory
    ...
    private GaussdbExtendOptions getGaussdbExtendOptions(ReadableConfig config) {
    ...
    public Set<ConfigOption<?>> optionalOptions() {
        ...
        optionalOptions.add(SINK_IGNORE_NULL_WHEN_UPDATE);
