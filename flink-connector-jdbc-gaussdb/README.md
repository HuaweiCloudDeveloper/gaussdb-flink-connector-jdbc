...
| 版本 | 适用环境 | 说明 |
|------|---------|------|
| **v3.3.2-1.20-normal** ⬅ 当前版本 | 标准 Apache Flink 1.20+ | 使用 Flink 标准 JDBC Connector 框架，兼容所有标准 Flink 发行版 |
| **v3.3.2-1.20-mrs** | 华为 MRS (MapReduce Service) | MRS 定制版，含自定义 Executor 和 Factory |

> 本 JAR 为 **normal 版本**，适用于 Apache Flink、CDH、HDP 等标准发行版。MRS 用户请下载 `-mrs` 版本。
